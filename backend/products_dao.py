...
def delete_product(connection, product_id):
    ...
    # First, delete the related records in orders_detail
    query_orders_detail = "DELETE FROM order_details WHERE product_id = %s"
    cursor.execute(query_orders_detail, (product_id,))
